                                ...
                                <div class="card-body">
                                    <form class="user" action="<?php print base_url();?>admin/kav/addkavling" method="post" enctype="multipart/form-data" name="addkavling" id="addkavling">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-input-sm" id="kav_name" name="kav_name" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-3 mt-2 form-input-sm">
                                                <label for="kav_shm">Nama di SHM bila beda nama</label>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-input-sm" id="kav_shm" name="kav_shm">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-3 mt-2 form-input-sm">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-input-sm" id="kav_lokasi" name="kav_lokasi" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-3 mt-2 form-input-sm">
                                                <label for="kav_luas">Luas (M2)</label>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-input-sm" id="kav_luas" name="kav_luas" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
