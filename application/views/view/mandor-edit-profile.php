                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="user" action="../controller/process_user.php?form=submit&action=edit-mandor&id=<?php print $_GET['id'];?>" method="post" enctype="multipart/form-data" name="edituser" id="edituser">
