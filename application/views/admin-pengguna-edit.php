                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="user" action="<?php print base_url();?>admin/user/updateUser/<?php print $user->user_id;?>" method="post" enctype="multipart/form-data" name="edituser" id="edituser">
                                        <div class="form-group row">
                                            <div class="col-sm-3 mt-2 form-input-sm">
                                                <label for="name">Nama</label>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-input-sm" id="name" name="name" value="<?php print $user->user_name;?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-3 mt-2 form-input-sm">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-input-sm" id="username" name="username" value="<?php print $user->user_username;?>" minlength='4' required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-3 mt-2 form-input-sm">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-check-inline">
                                                    <label class="form-check-label form-input-sm">
                                                        <input type="radio" class="form-check-input" name="type" id="typeadmin" value="admin" <?php print $user->user_type == 'admin' ? 'checked' : ''; ?>>Admin
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label form-input-sm">
                                                        <input type="radio" class="form-check-input" name="type" id="typemandor" value="mandor" <?php print $user->user_type == 'mandor' ? 'checked' : ''; ?>>Mandor
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label form-input-sm">
                                                        <input type="radio" class="form-check-input" name="type" id="typebhl" value="bhl" <?php print $user->user_type == 'bhl' ? 'checked' : ''; ?>>BHL
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
                                            if($user->user_profile){
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                    <img class="img-fluid" style="width: 10rem; height: 10rem; border-radius: 50%" src="<?php print base_url();?>img/profile/<?php print $user->user_profile;?>" alt="...">
                                                    </div>
                                                </div>
                                                <?php
                                            }
